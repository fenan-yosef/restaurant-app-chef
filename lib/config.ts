...
const developmentConfig: Partial<AppConfig> = {
    app: {
        ...
        isDevelopment: true,
        isProduction: false,
        adminChatIds: [856048902, 495806103, 652162568], // !!! REPLACE with your actual Telegram Chat ID for local admin
    },
    api: {
...
const productionConfig: Partial<AppConfig> = {
    app: {
        ...
        isDevelopment: false,
        isProduction: true,
        adminChatIds: [856048902, 495806103, 652162568], // !!! REPLACE with your actual Telegram Chat ID(s) for production admin
    },
    api: {
